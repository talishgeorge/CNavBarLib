...
open class CustomProgressBar: UIButton {
    ...
    fileprivate func mergeImagesOn(progress: CGFloat) -> UIImage {
        ...
        loadingColorImage?.draw(in: CGRect(x: 0, y: 0, width: progressSize.width,
                                           height: progressSize.height))
        buttonMainColorImage?.draw(in: CGRect(x: progressSize.width + 1, y: 0,
                                              width: unprogressSize.width,
                                              height: unprogressSize.height))
